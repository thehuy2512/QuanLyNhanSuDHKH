...
/**
 * Servlet implementation class xoanhansuController
 */
@WebServlet("/xoanhansuController")
public class xoanhansuController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public xoanhansuController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		    ...
		    if (hsbo.xoaHoSoById(mahs)==true) {
		    	RequestDispatcher rd = request.getRequestDispatcher("hienthinhansuController");
		    	...
		    	RequestDispatcher rd = request.getRequestDispatcher("chitietnhansuController");
		    	rd.forward(request, response);
		    }
		} catch (Exception e) {
